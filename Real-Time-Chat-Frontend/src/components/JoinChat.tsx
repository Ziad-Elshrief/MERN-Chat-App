...
export default function JoinChat({ setJoined }: joinChatProps) {
  ...
  return (
    <div className="max-w-lg text-white mt-20 mx-auto shadow-md rounded-xl overflow-hidden">
      ...
      <main className="py-8 px-10 bg-indigo-500">
        <form onSubmit={(e) => joinRoom(e)}>
          <div className="mb-5">
            ...
            <input
              className="bg-white dark:bg-slate-800 p-2 h-10 w-full caret-indigo-700 text-indigo-900 dark:text-indigo-300  rounded-lg focus:outline-indigo-700 autofill:shadow-[inset_0_0_0px_1000px_rgb(129,140,248)]"
              type="text"
              name="username"
              id="username"
